...
datasets:
  - fairleap-ai/fairleap-driver-earnings-regression-500
language:
  - id
  - en
tags:
  ...
  - not-for-production
model-index:
  - name: fairleap-v1-laborsupply-xgboost-2k
    results:
      - task:
          type: tabular-regression
          name: Driver Labour Supply (Hours Worked) Forecasting
        dataset:
          type: fairleap-ai/fairleap-driver-earnings-regression-500
          name: Fairleap Driver Earnings Regression 500
          split: test
        metrics:
          - type: mae
            value: 0.0067
            name: Mean Absolute Error (hours)
          - type: r_squared
            value: -0.3833
            name: R² Score
---
